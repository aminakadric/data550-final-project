...
This table includes the mean, standard deviation, median, and number of observation for batting stats for 1995 and 2021. Variables of focus are 
...
The figure below represents the distribution of player's batting average between 1995 and 2021. The boxplots for each year is stratified between dominant hand.

```{r, boxplot_batting_average}
